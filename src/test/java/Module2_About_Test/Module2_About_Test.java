...
public class Module2_About_Test extends Base_Class
{
	...
	public void verifyText() throws EncryptedDocumentException, IOException
	{
		...
		openMenu.clickSauceDemo_AboutPageAboutbtn();
		//Utility_Class.handleSauceDemo_AboutPageDropdown(driver, abt.Solutions);
		abt.handleSauceDemo_AboutPageDropdown(driver);
		abt.clickSauceDemo_AboutPageVTLink();
		String act_text=vt.verifyText();
		Cell cellInfo = Utility_Class.getTD(0, 1);
